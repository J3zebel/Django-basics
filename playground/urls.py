...
urlpatterns = [
    path('he', views.hello_world, name='hello'),
    ...
    path("api/v1/student/", views.datas),  # Changed viewss to views
    path("api/v1/student/<int:id>", views.data),  # Changed viewss to views
